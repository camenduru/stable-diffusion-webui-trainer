...
launch.git_clone(sd_scripts_repo, os.path.join(scripts.basedir(), "extensions", "stable-diffusion-webui-trainer", "sd-scripts"), "SD Scripts", sd_scripts_repo_commit_hash)
